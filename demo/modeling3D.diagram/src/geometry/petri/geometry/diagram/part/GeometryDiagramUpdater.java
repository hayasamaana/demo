...
public class GeometryDiagramUpdater {
	...
	* @generated
	*/
	public static List<GeometryNodeDescriptor> getGeometry_1000SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getPoints().iterator(); it.hasNext();) {
			...
			int visualID = GeometryVisualIDRegistry.getNodeVisualID(view, childElement);
	...
	*/
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getGeometry_1000ContainedLinks(View view) {
		Geometry modelElement = (Geometry) view.getElement();
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getPoint_2001ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getLine_4001ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getPoint_2001IncomingLinks(View view) {
		Point modelElement = (Point) view.getElement();
		Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences = EcoreUtil.CrossReferencer
				.find(view.eResource().getResourceSet().getResources());
		LinkedList<GeometryLinkDescriptor> result = new LinkedList<GeometryLinkDescriptor>();
		result.addAll(getIncomingTypeModelFacetLinks_Line_4001(modelElement, crossReferences));
		return result;
	}
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getLine_4001IncomingLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getPoint_2001OutgoingLinks(View view) {
		Point modelElement = (Point) view.getElement();
		LinkedList<GeometryLinkDescriptor> result = new LinkedList<GeometryLinkDescriptor>();
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getLine_4001OutgoingLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	private static Collection<GeometryLinkDescriptor> getContainedTypeModelFacetLinks_Line_4001(Geometry container) {
		LinkedList<GeometryLinkDescriptor> result = new LinkedList<GeometryLinkDescriptor>();
		for (Iterator<?> links = container.getLines().iterator(); links.hasNext();) {
			...
			if (LineEditPart.VISUAL_ID != GeometryVisualIDRegistry.getLinkWithClassVisualID(link)) {
				continue;
			}
			Point dst = link.getEnd();
			Point src = link.getStart();
			result.add(
					new GeometryLinkDescriptor(src, dst, link, GeometryElementTypes.Line_4001, LineEditPart.VISUAL_ID));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<GeometryLinkDescriptor> getIncomingTypeModelFacetLinks_Line_4001(Point target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<GeometryLinkDescriptor> result = new LinkedList<GeometryLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences.get(target);
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() != GeometryPackage.eINSTANCE.getLine_End()
			...
			Point src = link.getStart();
			result.add(new GeometryLinkDescriptor(src, target, link, GeometryElementTypes.Line_4001,
					LineEditPart.VISUAL_ID));
		}
		return result;
	}
	...
	* @generated
	*/
	private static Collection<GeometryLinkDescriptor> getOutgoingTypeModelFacetLinks_Line_4001(Point source) {
