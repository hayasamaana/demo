 ...
 * @generated
 */
public class GeometryViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateDiagramViewOperation op) {
		return GeometryEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& GeometryVisualIDRegistry.getDiagramVisualID(getSemanticElement(op.getSemanticAdapter())) != -1;
	}
	...
	*/
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				if (!GeometryElementTypes.isKnownElementType(elementType) || (!(elementType instanceof IHintedType))) {
				...
				if (!GeometryEditPart.MODEL_ID.equals(GeometryVisualIDRegistry.getModelID(op.getContainerView()))) {
					return false; // foreign diagram
				}
				switch (visualID) {
				case PointEditPart.VISUAL_ID:
					if (domainElement == null || visualID != GeometryVisualIDRegistry
	...
	*/
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null && visualID != GeometryVisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	*/
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		case LineEditPart.VISUAL_ID:
			return createLine_4001(getSemanticElement(semanticAdapter), containerView, index, persisted,
					preferencesHint);
		}
	...
	* @generated
	*/
	public Node createPoint_2001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Node label5001 = createLabel(node, GeometryVisualIDRegistry.getType(PointIdEditPart.VISUAL_ID));
	...
	* @generated
	*/
	public Edge createLine_4001(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		Node label6001 = createLabel(edge, GeometryVisualIDRegistry.getType(LineIdEditPart.VISUAL_ID));
