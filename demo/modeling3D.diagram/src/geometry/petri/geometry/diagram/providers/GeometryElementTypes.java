...
public class GeometryElementTypes {
	...
	*/
	private static DiagramElementTypeImages elementTypeImages = new DiagramElementTypeImages(
			GeometryDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory());
	...
	* @generated
	*/
	public static final IElementType Geometry_1000 = getElementType("modeling3D.diagram.Geometry_1000"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Point_2001 = getElementType("modeling3D.diagram.Point_2001"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Line_4001 = getElementType("modeling3D.diagram.Line_4001"); //$NON-NLS-1$
	...
	public static final DiagramElementTypes TYPED_INSTANCE = new DiagramElementTypes(elementTypeImages) {
		...
		*/
		...
		public boolean isKnownElementType(IElementType elementType) {
			return geometry.petri.geometry.diagram.providers.GeometryElementTypes.isKnownElementType(elementType);
		}
		...
		*/
		...
		public IElementType getElementTypeForVisualId(int visualID) {
			return geometry.petri.geometry.diagram.providers.GeometryElementTypes.getElementType(visualID);
		}
		...
		*/
		...
		public ENamedElement getDefiningNamedElement(IAdaptable elementTypeAdapter) {
			return geometry.petri.geometry.diagram.providers.GeometryElementTypes.getElement(elementTypeAdapter);
		}
	};
