...
import geometry.petri.geometry.diagram.part.Messages;
...
public class GeometryNavigatorContentProvider implements ICommonContentProvider {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(topViews, GeometryEditPart.MODEL_ID), file, false));
	...
	*/
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case GeometryEditPart.VISUAL_ID: {
			...
			GeometryNavigatorGroup links = new GeometryNavigatorGroup(Messages.NavigatorGroupName_Geometry_1000_links,
					"icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					GeometryVisualIDRegistry.getType(PointEditPart.VISUAL_ID));
		...
		case PointEditPart.VISUAL_ID: {
			...
			GeometryNavigatorGroup incominglinks = new GeometryNavigatorGroup(
					Messages.NavigatorGroupName_Point_2001_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			GeometryNavigatorGroup outgoinglinks = new GeometryNavigatorGroup(
					Messages.NavigatorGroupName_Point_2001_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case LineEditPart.VISUAL_ID: {
			LinkedList<GeometryAbstractNavigatorItem> result = new LinkedList<GeometryAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			GeometryNavigatorGroup target = new GeometryNavigatorGroup(Messages.NavigatorGroupName_Line_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GeometryNavigatorGroup source = new GeometryNavigatorGroup(Messages.NavigatorGroupName_Line_4001_source,
	...
	*/
	 ...
	 * @generated
	 */
	private Collection<GeometryNavigatorItem> createNavigatorItems(Collection<View> views, Object parent,
			boolean isLeafs) {
		ArrayList<GeometryNavigatorItem> result = new ArrayList<GeometryNavigatorItem>(views.size());
		for (View nextView : views) {
