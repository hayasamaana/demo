...
import geometry.petri.geometry.diagram.edit.policies.GeometryCanonicalEditPolicy;
import geometry.petri.geometry.diagram.edit.policies.GeometryItemSemanticEditPolicy;
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(GeometryVisualIDRegistry.TYPED_INSTANCE));
