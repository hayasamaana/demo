...
import geometry.petri.geometry.diagram.edit.commands.LineCreateCommand;
import geometry.petri.geometry.diagram.edit.commands.LineReorientCommand;
 ...
 * @generated
 */
public class PointItemSemanticEditPolicy extends GeometryBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public PointItemSemanticEditPolicy() {
		super(GeometryElementTypes.Point_2001);
	}
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (GeometryElementTypes.Line_4001 == req.getElementType()) {
			return getGEFWrapper(new LineCreateCommand(req, req.getSource(), req.getTarget()));
		}
		return null;
	}
