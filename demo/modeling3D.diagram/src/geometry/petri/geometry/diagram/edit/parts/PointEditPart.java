...
import geometry.petri.geometry.diagram.edit.policies.PointItemSemanticEditPolicy;
...
public class PointEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof PointIdEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GeometryVisualIDRegistry.getType(PointIdEditPart.VISUAL_ID));
	}
