...
public class GeometryBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(GeometryVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = GeometryElementTypes.getElementType(getVisualID(request));
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = GeometryDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
			GeometryDiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
	...
	public static class LinkConstraints {
		...
		*/
		 ...
		 * @generated
		 */
		public boolean canCreateLine_4001(Geometry container, Point source, Point target) {
		...
		* @generated
		*/
		public boolean canExistLine_4001(Geometry container, Line linkInstance, Point source, Point target) {
			return true;
		}
	}
