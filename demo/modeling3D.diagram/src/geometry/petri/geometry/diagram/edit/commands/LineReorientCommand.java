...
public class LineReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return GeometryBaseItemSemanticEditPolicy.getLinkConstraints().canExistLine_4001(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Geometry container = (Geometry) getLink().eContainer();
		return GeometryBaseItemSemanticEditPolicy.getLinkConstraints().canExistLine_4001(container, getLink(), source,
				getNewTarget());
	}
