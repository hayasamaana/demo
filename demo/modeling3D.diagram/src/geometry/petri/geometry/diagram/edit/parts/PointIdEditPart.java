 ...
 * @generated
 */
public class PointIdEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				GeometryVisualIDRegistry.getType(geometry.petri.geometry.diagram.edit.parts.PointIdEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public PointIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GeometryParserProvider.getParser(GeometryElementTypes.Point_2001, getParserElement(),
					GeometryVisualIDRegistry
							.getType(geometry.petri.geometry.diagram.edit.parts.PointIdEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PoindIdFigure();
	}

	/**
	 * @generated
	 */
	public class PoindIdFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PoindIdFigure() {
			this.setText("<...>");
		}
