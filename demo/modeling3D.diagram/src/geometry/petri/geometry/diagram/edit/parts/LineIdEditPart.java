...
import geometry.petri.geometry.diagram.edit.policies.GeometryTextSelectionEditPolicy;
 ...
 * @generated
 */
public class LineIdEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				GeometryVisualIDRegistry.getType(geometry.petri.geometry.diagram.edit.parts.LineIdEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public LineIdEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new GeometryTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return GeometryElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GeometryParserProvider.getParser(GeometryElementTypes.Line_4001, getParserElement(),
					GeometryVisualIDRegistry
							.getType(geometry.petri.geometry.diagram.edit.parts.LineIdEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, GeometryEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new LineIdFigure();
	}

	/**
	 * @generated
	 */
	public class LineIdFigure extends WrappingLabel {
