/**
 */
package geometry.petri.geometry.provider;
...
/**
 * This is the item provider adapter for a {@link geometry.petri.geometry.Point} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PointItemProvider extends PositionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeoObject_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeoObject_id_feature", "_UI_GeoObject_type"),
				 GeometryPackage.Literals.GEO_OBJECT__ID,
				 true,
				 false,
				 false,
	...
	protected void addInPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Point_in_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Point_in_feature", "_UI_Point_type"),
				 GeometryPackage.Literals.POINT__IN,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Point_out_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Point_out_feature", "_UI_Point_type"),
				 GeometryPackage.Literals.POINT__OUT,
				 true,
				 false,
				 true,
				 null,
