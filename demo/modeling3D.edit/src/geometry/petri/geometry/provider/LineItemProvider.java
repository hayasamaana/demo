...
/**
 * This is the item provider adapter for a {@link geometry.petri.geometry.Line} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LineItemProvider extends GeoObjectItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Line_start_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Line_start_feature", "_UI_Line_type"),
				 GeometryPackage.Literals.LINE__START,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GeometryPackage.Literals.LINE__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GeometryPackage.Literals.LINE__INTERMEDIATE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GeometryPackage.Literals.LINE__INTERMEDIATE,
				 GeometryFactory.eINSTANCE.createPosition()));
