...
public abstract class AbstractMyDslRuntimeModule extends org.eclipse.xtext.service.DefaultRuntimeModule {
	...
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("alxx");
	}
	...
	public Class<? extends org.eclipse.xtext.parsetree.reconstr.IParseTreeConstructor> bindIParseTreeConstructor() {
		return org.xtext.example.mydsl.parseTreeConstruction.MyDslParsetreeConstructor.class;
	}
