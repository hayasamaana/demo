...
/**
 * This is the item provider adapter for a {@link animation.petri.Animations.Animation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnimationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Animation_geometry_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Animation_geometry_feature", "_UI_Animation_type"),
				 AnimationsPackage.Literals.ANIMATION__GEOMETRY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Animation)object).getGeometry();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Animation.class)) {
			case AnimationsPackage.ANIMATION__GEOMETRY:
